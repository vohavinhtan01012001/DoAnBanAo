                    ...
                    <div className="">
                        <div className="app__container--formLogin">
                            ...
                            <form onSubmit={registerSubmit}>
                                ...
                                <span className='error'>{registerInput.error_list.name ? "Vui lòng nhập tên của bạn!": ""}</span>
                                <div className="formLogin__email">
                                    <div className="formLogin__email--icon">
                                ...
                                <span className='error'>{registerInput.error_list.email == "The email has already been taken." ? "Email này đã được đăng ký!": registerInput.error_list.email ? "Email không hợp lệ!": ""}</span>
                                ...
                                <span className='error'>{registerInput.error_list.password == "The password must be at least 8 characters." ? "Mật khẩu bắt buộc phải 8 kí tự trở lên!": registerInput.error_list.password ? "Vui lòng nhập mật khẩu của bạn!": ""}</span>
