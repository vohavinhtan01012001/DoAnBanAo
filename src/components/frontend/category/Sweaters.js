                ...
                <div className="grid wide">
                    <div className="row">
                        <div className="app__container--category">
                            ...
                            <FontAwesomeIcon icon={faChevronRight} />
                            <p className="app__container--text">SWEATERS</p>
                        </div>
                    </div>
                </div>
                <div className="grid wide">
                    <div className="row">
                        ...
                        <div className="col l-9">
                            <div className="tshirts__title">
                                <h3 className="tshirts__title--heading">SWEATERS</h3>
                                        ...
                                        viewProduct.map((item, index) => {
                                            return (
                                                item.category_id === 3 ?
                                                    ...
                                                    : index === viewProduct.length ? <h1 key={index} className="col-lg-4 col-md-4 col-sm-6 col-xs-6 error" >Chưa có sản phẩm này</h1> : ""
                                            )
                                        })
                                    }
