                ...
                <div className='row'>
                    <div className="col-lg-12 col-xs-12 pd5">
        				...
        				<div className="clearfix page-description add-height-img fs-4 text">
                            ...
                            <p ><img src="//file.hstatic.net/200000305259/file/banner_gioi_thieu_600x600px-03_e75096634db74ed097b81a3d5baa1c41_master.jpg" width="600" height="600" className="dt-width-auto"/>
                            </p>
                            <p ><img src="//file.hstatic.net/200000305259/file/banner_gioi_thieu_600x600px-01_53700fa8cc4e4fd28f78c749e0b90738_master.jpg" width="600" height="600" className="dt-width-auto"/></p>
                            <p ><img src="//file.hstatic.net/200000305259/file/banner_gioi_thieu_600x600px-02_60101bf7669d48119ded1961a3c7f692_master.jpg" width="600" height="600" className="dt-width-auto"/></p>
                            <p >&nbsp;</p>
                            <p >&nbsp;</p><p>&nbsp;</p>
        				</div>
        			</div>
